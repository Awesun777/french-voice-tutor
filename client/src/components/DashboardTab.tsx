              ...
              {[
                {
                  ...
                  label: "Watch",
                  sub: `${videos.length} video${videos.length === 1 ? "" : "s"} · live transcripts`,
                ...
                },
                {
                  ...
                  label: "Read",
                  sub: `${articles.length} article${articles.length === 1 ? "" : "s"} · hover any word`,
...
function Shortcuts() {
  ...
  const items = [
    ...
    },
    {
      ...
      body: "Hold both keys and speak; release to send. Highlight a phrase first and just ask “what does it mean?” — the tutor answers in writing.",
      tone: "bg-speaking-surface text-speaking",
    },
  ];
